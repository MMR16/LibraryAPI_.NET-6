...
{
    public class CourseLibraryContexts : DbContext
    {
        public CourseLibraryContexts(DbContextOptions<CourseLibraryContexts> o) : base(o)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Author>().HasData(
                ...
                new Author()
                {
                    ...
                    DateOfBirth = new DateTime(1991, 12, 16),
                ...
                new Author()
                {
                    ...
                    DateOfBirth = new DateTime(1992, 3, 6),
                    MainCategory = "Singing"
                },
                new Author()
                {
