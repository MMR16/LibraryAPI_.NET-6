...
{
    [DbContext(typeof(CourseLibraryContexts))]
    partial class CourseLibraryContextsModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryAPI.Entites.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1991, 12, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            FirstName = "Eli",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1992, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            FirstName = "Arnold",
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1993, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            DateOfBirth = new DateTimeOffset(new DateTime(1999, 10, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            FirstName = "Atherton",
            ...
            modelBuilder.Entity("LibraryAPI.Entites.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibraryAPI.Entites.Course", b =>
                {
                    b.HasOne("LibraryAPI.Entites.Author", "Author")
                        .WithMany("Courses")
